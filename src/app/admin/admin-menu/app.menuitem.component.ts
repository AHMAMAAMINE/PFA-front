...
@Component({
    ...
    providers: [AdminInterfaceComponent],
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    key: string;
    constructor(public appMain: AdminInterfaceComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
